...
extends Module {
    ...
    private final NumberSetting fallDistanceSetting = new NumberSetting("Fall Distance", Double.valueOf(3.0), Double.valueOf(0.0), Double.valueOf(10.0), Double.valueOf(0.5));
